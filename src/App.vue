  ...
  methods: {
    ...
    submit() {
      ...
      for (var i = 0; i < this.Data.length; i++) {
        this.Total = this.Total + this.Data[i].Price * this.Data[i].Amount;
      }
    },
    cleardata() {
      this.Total = 0;
